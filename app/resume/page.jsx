...
const education = {
  ...
  items: [
    {
      institute: "ISME, Bangalore",
      degree: "PGDM",
      date: "2017 - 2019",
    },
    {
      institute: "SAIT, Jabalpur",
      degree: "B.E in ECE",
      date: "2011 - 2015",
    },
  ],
                    ...
                    return (
                      <li key={index}>
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger className="w-full h-[150px] bg-[#232329] flex flex-col justify-center items-center rounded-xl group">
